...
## Summary/Languages
The Social Network app demonstrates using APIs and interacting with MongoDB using Mongoose. This challenge also introduces us to subdocuments within MongoDB. The main purpose of this challenge is to create APIs for CRUD operations using MongoDB with Mongoose.
